...
\author{
	\authorstyle{Gabriel Taubin\textsuperscript{1}, Manuel Dubinsky\textsuperscript{2}, 
	César Massri\textsuperscript{3}, Fernando Asteasuain\textsuperscript{2}} % Authors
	\newline\newline % Space before institutions
	\textsuperscript{1}\institution{Engineering Dept., Brown University, Providence, USA} \\
	\textsuperscript{2}\institution{Dpto. Tecnología y Administración, Ingeniería Informática, Universidad Nacional de Avellaneda, Argentina}\\ % Institution 1
	\textsuperscript{3}\institution{Dpto. de Matemática, FCEyN, Universidad de Buenos Aires, Argentina}
}
...
espacio tridimensional. Son objetos de estudio en el área de 
...
laplaciana}. Actualmente hay importantes lineas de trabajo abordando 
