...
una orientacion de los ejes $G$ y una función de pesos en los 
...
El problema surgió como una variante de la definición de \textit{1-forma 
diferencial} en el contexto de \textit{mallas 3D}. 

\bigskip

Las formas diferenciales \cite{S:1965,T:2008} conceptualizan la noción 
de entidad integrable. Informalmente se puede pensar en una 
...
que mide una superficie infinitesimal y que puede ser integrada a lo de 
una superficie. Y en general, una \textit{k-forma diferencial} está 
asociada a una variedad diferencial $k$-dimensional y puede ser 
...
de Stokes}. Además de la naturaleza analítica de este punto de vista, 
...
variedades vincualdas mediante mapas diferenciales. El precursor de la 
teoría fue \textit{Elie Cartan} a fines del siglo XIX.
