...
\frametitle{Conclusiones}
	...
	\begin{itemize}
	\only<1->{
		\item Formulamos una versión más general del problema de integración 
		de $1$-formas diferenciales sobre mallas poligonales
	}
	\only<2->{
		\item Definimos un criterio para estimar la proyección ortogonal 
		de un vector sobre el subespacio generado por las columnas de una 
		matriz de incidencia dirigida
	}
	\only<3->{
		\item Implementamos un algoritmo basado en una heurística para 
...
\frametitle{Trabajo futuro}
	...
	\only<2->{
		\item Proponer argumentos estadísticos que garanticen cotas para 
