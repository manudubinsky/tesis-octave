...
% affiliations
\author{\IEEEauthorblockN{César Massri}
\IEEEauthorblockA{Dpto. de Matemática\\
Facultad de Ciencias Exactas y Naturales\\
Universidad de Buenos Aires\\
Argentina}
\and
\IEEEauthorblockN{Manuel Dubinsky y Fernando Asteasuain}
...
contraria de un eje, su término aociado en el complejo de co-cadena 
