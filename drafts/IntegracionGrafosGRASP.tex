...
%\
%
%\noindent {\bf Relación entre la {\it $\alpha$-norma} y la norma de la proyección ortogonal}
%
%Fijemos una matriz $D$ y consideremos
%$S=\langle d_1,\ldots,d_{n}\rangle$ el subespacio generado por la columnas
%de $D$ y sea $\{s_1,\ldots,s_{k}\}$ una base ortonormal de $S$, $k\leq n$.
%Como hemos mencionado, la norma de $p_S(f)$ puede calcularse
%\[
%\|p_S(f)\|^2=|fs_1|^2+\ldots+|fs_{k}|^2
%\]
%y la $\alpha$-norma
%\[
%\alpha(D,f)^2=\frac{|fd_1|^2}{\|d_1\|^2}+\ldots+\frac{|fd_n|^2}{\|d_n\|^2}.
%\]
%Por simplicidad denotemos $e_i:=d_i/\|d_i\|$.
%Consideremos la matriz rectangular $C=\{c_{ij}\}$ que verifica
%$e_i=\sum c_{ij}s_j$ y los vectores $x=(fs_1,\ldots,fs_k)$
%e $y=(fe_1,\ldots,fe_n)$. Es fácil verificar
%que $Cx=y$, $\|x\|=\|p_S(f)\|$ y que 
%$\alpha=\|y\|$. Dado que $C$ tiene rango máximo, 
%existen constantes positivas $m$ y $M$ tales que
%\[
%m\|x\|\le \|Cx\|\le M\|x\|,\quad\forall x.
%\]
%La constante $M$ resulta de la continuidad de $C$
%y la constante $m$ se sigue de que existe una matriz $C'$ 
%tal que $C'Cx=x$ para todo $x$ y entonces
%$\|x\|=\|C'Cx\|\le \|C'\|\|Cx\|$, luego $m=1/\|C'\|$.
%Finalmente obtenemos la relación
%para $x=(fs_1,\ldots,fs_k)$
%\[
%m\|p_S(f)\|\le \alpha(D,f)\le M\|p_S(f)\|.
%\]
%En otras palabras, el crecimiento o decrecimiento
%de $\alpha$ acota al de $\|p_S(f)\|$.
...
\bibitem[Manders, Adleman, 1976]{MA:1976}
Manders 	K., Adleman L.,
